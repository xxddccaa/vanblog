...
这个仓库最初源于 VanBlog，现在已经作为我独立维护的博客项目持续迭代。当前代码基线定为 `v1.5.8`，默认部署方式已经完全切换为 Docker Compose 多容器架构。
...
kevinchina/deeplearning:vanblog-all-in-one-v1.5.8-<image-id>
kevinchina/deeplearning:vanblog-all-in-one-v1.5.8
...
pnpm release:all-in-one:latest --version v1.5.8 --image-id <image-id>
```
...
- [`docs/releases/v1.5.8.md`](docs/releases/v1.5.8.md)
