...
export default function (props: {}) {
  return (
    <div
      ...
      className="p-24 bg-gray-300 dark:bg-dark-2 transform  rotate-45 -translate-x-36 -translate-y-36 sm:-translate-y-32 sm:-translate-x-32"
    >
      <svg
        ...
        p-id="2212"
        className="fill-gray-600  dark:text-dark-400 w-4 h-4 right-xs transform -translate-y-2 sm:w-5 sm:h-5 sm:right-2"
