...
ENV POSTGRES_EFFECTIVE_CACHE_SIZE=24GB
ENV POSTGRES_MAX_CONNECTIONS=200
ENV POSTGRES_CHECKPOINT_TIMEOUT=15min
...
ENV VAN_BLOG_DEBUG_SUPER_TOKEN=""
ENV VAN_BLOG_CLOUDFLARE_API_TOKEN=""
ENV VAN_BLOG_CLOUDFLARE_ZONE_ID=""
ENV VANBLOG_ISR_TOKEN=""
