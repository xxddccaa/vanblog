...
当前代码基线已经推进到 `v1.6.0`，默认镜像仓库继续固定为长期保留的 `kevinchina/deeplearning`。
...
3. 确认根目录 `package.json` 的版本号正确，例如 `1.6.0`，并统一成发布标签 `vX.Y.Z`。
...
- 自动读取 `package.json` 版本，例如 `1.6.0`，并规范成 `v1.6.0`
